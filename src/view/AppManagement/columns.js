...
export default function(Vue) {
  ...
  return [
    {
      title: i18n.appManagement40_v1_2_6_3,
      align: 'center',
      key: 'type_name'
    },
    {
      title: `${i18n.appManagement39_v1_2_6_3}`,
      align: 'center',
      key: 'update_type',
      render(h, { row }) {
        return <span>{row.update_type == '1' ? `${i18n.appManagement38_v1_2_6_3}` : ''}{row.update_type == '2' ? `${i18n.appManagement37_v1_2_6_3}` : ''}</span>
      }
    },
    {
