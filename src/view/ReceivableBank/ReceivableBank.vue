  ...
  <div id="ReceivableBank">
    ...
    >
      ...
      >
        ...
        <FormItem :label="`${i18n_lang.receivableBank101_v1_2_5_4}`" prop="level">
...
export default {
  ...
  methods: {
    ...
    handleOpenModal(row) {
      ...
      this.editInfo.limit_once_min = MathDiv(this.editInfo.limit_once_min, 100)
      this.editInfo.limit_once_max = MathDiv(this.editInfo.limit_once_max, 100)
      this.editInfo.limit_day_max = MathDiv(this.editInfo.limit_day_max, 100)
      this.editInfo.limit_max = MathDiv(this.editInfo.limit_max, 100)
