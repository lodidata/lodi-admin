...
export default function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.limit_once_min === 0 ? i18n.receivableBank73 : row.limit_once_min / 100}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.limit_once_max === 0 ? i18n.receivableBank73 : row.limit_once_max / 100}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.limit_day_max === 0 ? i18n.receivableBank73 : row.limit_day_max / 100}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.limit_max === 0 ? i18n.receivableBank73 : row.limit_max / 100}</span>
      }
    },
    {
