...
export default function(Vue) {
  ...
  return [
    {
      title: `${i18n.newThirdPayment63}`,//货币类型
      align: 'center',
      key: 'name',
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.currency_type == 1 ? `${i18n.newThirdPayment64}` : `${i18n.newThirdPayment65}`}</span>
      }
    },
    {
      title: `${i18n.newThirdPayment30}`,//渠道名称
      align: 'center',
      key: 'name',
      minWidth: 80
    },
    {
      title: `${i18n.newThirdPayment56}`,//渠道LOGO
      align: 'center',
      key: 'logo',
      minWidth: 80,
      render(h, { row }) {
    ...
    {
      title: `${i18n.newThirdPayment34}`,//支付通道
      align: 'center',
      key: 'channel_num',
      minWidth: 80
    },
    {
      title: `${i18n.newThirdPayment35}`,//渠道状态
      align: 'center',
      key: 'status',
      minWidth: 80,
      render(h, { row }) {
