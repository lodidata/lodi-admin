...
export const chaseColumns = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      minWidth: 70,
      render(h, { row }) {
        return <span>{row.increment_bet / 100}</span>
      },
      myExt: {
        label: 'increment_bet'
      }
    ...
    },
    {
      ...
      minWidth: 70,
      render(h, { row }) {
        return <span>{row.send_money / 100}</span>
      },
      myExt: {
        label: 'send_money'
      }
    },
    {
      ...
      minWidth: 70,
      render(h, { row }) {
        return <span>{row.profit / 100}</span>
      },
      myExt: {
        label: 'profit'
      }
...
export const detailPlayDescColumns = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.pay_money / 100}</span>
      }
    }
  ]
}
...
export const detailChaseColumns = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.current_bet / 100}</span>
      }
    },
    {
