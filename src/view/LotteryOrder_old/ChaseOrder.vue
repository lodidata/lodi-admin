      ...
      <div v-if="Object.keys(detailData).length" class="tab_box">
        ...
        <div class="content">
          <Row>
            ...
            <div class="item">
              ...
              <span>{{ floatMath(detailData.chase_msg.money,100) }}</span>
            </div>
            </Col>
            <Col span="8">
            <div class="item">
            ...
            <div class="item">
              ...
              <span>{{ floatMath(detailData.chase_msg.money_reward,100) }}</span>
            </div>
            </Col>
            <Col span="8">
            <div class="item">
              <p>{{i18n_lang.lotteryOrder21}}</p>
              <span>{{ floatMath(detailData.chase_msg.money_lose,100) }}</span>
            </div>
            </Col>
          </Row>
          <Row>
        ...
        <p class="title">
          ...
          <span class="title_des">
            <em style="color:red">{{i18n_lang.lotteryOrder24}}{{ floatMath(detailData.play_desc.total_money,100) }}</em>
          </span>
        </p>
        <div class="content">
