  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: `${i18n_lang.profitStatement60_v1_5_7}`,
          align: 'center',
          key: 'SMALL',
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.yk_SMALL}</span>
          }
        },
        // {
    ...
    {
      title: `${i18n_lang.profitStatement60_statement}`,
      align: 'center',
      myExt: {
        label: 'bet'
      },
      children: [
        ...
        },
        {
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_ESPORTS}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement36}`,
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_ARCADE}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement37}`,
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_TABLE}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement38}`,
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_SPORT}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement39}`,
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_SABONG}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement59_lottery}`,
        ...
        },
        {
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_BINGO}</span>
          }
        },
        {
          title: `${i18n_lang.profitStatement60_v1_5_7}`,
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.bet_SMALL}</span>
          }
        }
        // {
        //   title: `${i18n_lang.profitStatement40}`,
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          minWidth: 100,
          render(h, { row }) {
            return <span>{row.zb_SMALL ? `${row.zb_SMALL}%` : ``}</span>
          }
        },
        // {
        //   title: `${i18n_lang.profitStatement40}`,
