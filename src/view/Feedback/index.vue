  ...
  export default {
    ...
    methods: {
      ...
      handleBtn(row){
        ...
        switch (row.type) {
        	case 1:
        		this.handleInfo.type_text = `${this.i18n_lang.feedback15}`
        		break;
        	case 2:
        		this.handleInfo.type_text = `${this.i18n_lang.feedback16}`
        		break;
          case 3:
          	this.handleInfo.type_text = `${this.i18n_lang.feedback17}`
          	break;
          case 4:
          	this.handleInfo.type_text = `${this.i18n_lang.feedback18}`
          	break;
        }
