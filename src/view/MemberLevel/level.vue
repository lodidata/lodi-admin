          ...
          <Row>
            ...
            <Col span="8">
              <div class="item">
                ...
                <span>{{ formatMathDiv(detailData.LevelDetailData.deposit_money,100) }}</span>
              </div>
            </Col>
            <Col span="8">
              <div class="item">
                <p>{{i18n_lang.memberLevel7}}</p>
                <span>{{ formatMathDiv(detailData.LevelDetailData.lottery_money,100) }}</span>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            <Col span="6">
              <div class="item">
                ...
                <span>{{ formatMathDiv(detailData.LevelDetailData.promote_handsel) || i18n_lang.memberLevel12 }}</span>
              </div>
            </Col>
            <Col span="6">
              <div class="item">
                <p>{{i18n_lang.memberLevel17}}</p>
                <span>{{ formatMathDiv(detailData.LevelDetailData.transfer_handsel,100) || i18n_lang.memberLevel12 }}</span>
              </div>
            </Col>
            <Col span="6">
              <div class="item">
                <p>{{i18n_lang.memberLevel18}}</p>
                <span>{{ formatMathDiv(detailData.LevelDetailData.upgrade_dml_percent,100) || i18n_lang.memberLevel12 }}</span>
              </div>
            </Col>
            <Col span="6">
              <div class="item">
            ...
            <Col span="6">
              <div class="item">
                ...
                <span>{{ formatMathDiv(detailData.LevelDetailData.monthly_money,100) || i18n_lang.memberLevel12 }}</span>
              </div>
            </Col>
            <Col span="6">
              <div class="item">
