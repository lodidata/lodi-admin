  ...
  <div id="MemberLog">
    ...
    <Card dis-hover class="query_box">
      <div class="query_con">
        ...
        <div class="item">
          <span>{{i18n_lang.memberLog36}}</span>
          <Select v-model="query.platform" style="width:150px">
            <Option value='-1'>{{i18n_lang.memberLog1}}</Option>
      ...
      <div class="query_btns">
        ...
        <Button type="primary" style="margin-left: 5px;" icon="md-download" @click="exportData">{{i18n_lang.memberLog37_v1_2_5_3}}</Button>
      </div>
    </Card>
...
export default {
  ...
  methods: {
    ...
    async getData(i = 1) {
      ...
      query.date_begin = query.date_begin ? this.$dateFormat(query.date_begin) : ''
      query.date_end = query.date_end ? this.$dateFormat(query.date_end) : ''
      query.platform = query.platform == -1 ? '' : query.platform
