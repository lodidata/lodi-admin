...
export default function(Vue) {
  const i18n = Vue.$t('liveOrder')
  return [
    {
      title: i18n.liveOrder14,
      align: 'center',
      minWidth: 140,
      key: 'order_number'
    },
    {
      title: i18n.liveOrder15,
      align: 'center',
      minWidth: 100,
      render: (h, { row }) => {
        return (
          <span class={row.tags === 4 || row.tags === 7 || row.tags === i18n.liveOrder16 ? 'red' : 'user_link'} on-click={_ => Vue.handleUserDetail(row)}>
            {row.user_name}
          </span>
        )
      }
    ...
    {
      title: i18n.liveOrder17,
      align: 'center',
      minWidth: 100,
      key: 'GameStartTime'
    },
    {
      title: i18n.liveOrder18,
      align: 'center',
      minWidth: 100,
      key: 'GameEndTime'
    },
    {
      title: i18n.liveOrder19,
      align: 'center',
      minWidth: 100,
      key: 'game_name',
      render(h, { row }) {
