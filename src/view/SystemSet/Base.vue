  ...
  <div id="Base">
    ...
    <Row>
      ...
      <div class="content">
        ...
        <div class="item">
          <p>{{i18n_lang.systemSet112_verification_code}}</p>
          <span>
            <Switch v-model="register.register_verify_switch"></Switch>
          </span>
        </div>
        <!-- <div class="item">
          <p>注册方式</p>
      ...
      <p class="title">{{i18n_lang.systemSet109_version}}</p>
      <div class="content">
        <div class="item">
          <p>{{i18n_lang.systemSet110_version}}</p>
          <span>
            <Input v-model="market.h5_version" disabled style="width: 110px;"/>
            <Button size="large" type="primary" @click="market.h5_version = `${new Date().getTime()}`">{{i18n_lang.systemSet111_version}}</Button>
          </span>
        </div>
      </div>
      </Col>
    ...
    <Row>
      <!-- 打码量一键清空 -->
      <p class="title">
        <span>{{i18n_lang.systemSet109_AmountClearing}}</span>
      </p>
      <div class="content">
        <Row>
          <Col span="24">
          <div class="item">
            <p style="min-width:60px">{{i18n_lang.systemSet110_AmountClearing}}<=</p>
            <span>
              <!-- <Switch v-model="system.register_limit_ip_switch"></Switch> -->
              <Input v-model="system.dml_amount" />
            </span>
          </div>
          </Col>
        </Row>
    ...
    <Row>
      ...
      <div class="content">
        ...
        <Row>
          ...
          <Col span="6">
            <div class="item">
              <p style="min-width:60px">{{i18n_lang.systemSet111_v1_2_5_4}}>=</p>
              <span>
                <Input v-model="admin_pin_password.add_direct_balance"/>
              </span>
            </div>
          </Col>
        </Row>
  ...
  export default {
    ...
    methods: {
      ...
      async getData() {
        ...
        this.audit = audit
        this.system = system
        this.system.dml_amount = system.dml_amount ? system.dml_amount / 100 : system.dml_amount
        this.agent = agent
      ...
      async save() {
        ...
        req.system.dml_amount = req.system.dml_amount ? req.system.dml_amount * 100 : req.system.dml_amount
        const res = await this.$axios.request({
          url: '/system/bases',
          method: 'PUT',
          data: req
