export const dataList = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      key: 'give_amount',
      render(h, { row }) {
        return <span>{row.give_amount / 100}</span>
      }
    },
    {
      ...
      key: 'dm_num',
      render(h, { row }) {
        return <span>{row.dm_num / 100}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.total_give_amount / 100}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{row.receive_total_amount / 100}</span>
      }
    },
    {
