<template>
  <div>
    ...
    <div style="margin-bottom: 15px;">
      <Button type="primary" @click="getFailtext()">{{i18n_lang.balaceTransfer43_v1_2_5_2}}</Button>
    </div>
    ...
    <Modal
      ...
      :title="`${i18n_lang.balaceTransfer43_v1_2_5_2}`"
      :width="550"
      :footer-hide="true"
      :styles="{ top: '100px' }">
      <p class="hintText">{{i18n_lang.balaceTransfer44_v1_2_5_2}}</p>
      <p class="hintText">{{i18n_lang.balaceTransfer45_v1_2_5_2}}</p>
      <p class="hintText">{{i18n_lang.balaceTransfer46_v1_2_5_2}}</p>
      <p class="hintText">{{i18n_lang.balaceTransfer47_v1_2_5_2}}</p>
      <P class="hintText">{{i18n_lang.balaceTransfer48_v1_2_5_2}}</P>
      <P class="hintText"><span class="red_text">{{i18n_lang.balaceTransfer49_v1_2_5_2}}</span>{{i18n_lang.balaceTransfer50_v1_2_5_2}}</P>
      <P class="hintText">{{i18n_lang.balaceTransfer51_v1_2_5_2}}</P>
      <P class="hintText">
        <span class="red_text">{{gameHintText.game}}</span>
      </P>
    </Modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async getFailtext(){
      const res = await this.$axios.request({
        url: '/cash/record/transfer/failtext',
        method: 'GET',
        params: {}
      })
      if (res.status !== 200) {
      ...
      this.gameHintText = { ...res.data }
      this.visible.hint = true
    }
  }
}
</script>
