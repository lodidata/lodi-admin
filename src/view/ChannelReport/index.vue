  ...
  export default {
    ...
    methods: {
      ...
      async getList(index = 1) {
        ...
        const objSource = res.data[0], columns = this.columns, columns2 = [];
        ...
        columns.map((item, index)=>{
          if(objSource){
            ...
            if(item.key == 'channel_name'){
              columns2.push(item)
            }
            if(item.key == 'click_num' && objSource.click_num != undefined){
              columns2.push(item)
            }
            if(item.key == 'distinct_click' && objSource.distinct_click != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_click_num' && objSource.first_click_num != undefined){
              columns2.push(item)
            }
            if(item.key == 'register_num' && objSource.register_num != undefined){
              columns2.push(item)
            }
            if(item.key == 'register_ip_count' && objSource.register_ip_count != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_register_num' && objSource.first_register_num != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_register_ip_count' && objSource.first_register_ip_count != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_recharge_user' && objSource.first_recharge_user != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_recharge' && objSource.first_recharge != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_withdraw' && objSource.first_withdraw != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_bet' && objSource.first_bet != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_prize' && objSource.first_prize != undefined){
              columns2.push(item)
            }
            if(item.key == 'first_diff_tzpc' && objSource.first_diff_tzpc != undefined){
              columns2.push(item)
            }
            if(item.key == 'cz_person' && objSource.cz_person != undefined){
              columns2.push(item)
            }
            if(item.key == 'cz_amount' && objSource.cz_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'qk_person' && objSource.qk_person != undefined){
              columns2.push(item)
            }
            if(item.key == 'qk_amount' && objSource.qk_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'diff_cqk' && objSource.diff_cqk != undefined){
              columns2.push(item)
            }
            if(item.key == 'tz_amount' && objSource.tz_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'pc_amount' && objSource.pc_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'diff_tzpc' && objSource.diff_tzpc != undefined){
              columns2.push(item)
            }
            if(item.key == 'hd_amount' && objSource.hd_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'hs_amount' && objSource.hs_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'js_amount' && objSource.js_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'zk_amount' && objSource.zk_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'fyz_amount' && objSource.fyz_amount != undefined){
              columns2.push(item)
            }
            if(item.key == 'award_money' && objSource.award_money != undefined){
              columns2.push(item)
            }
            if(item.key == 'operate' && objSource.operate){
              columns2.push(item)
            }
          }else{
            if(item.key == 'channel_id'){
