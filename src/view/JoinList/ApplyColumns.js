...
export default function(Vue) {
  ...
  return [
    ...
    {
      title: `${i18n_lang.joinList84_v1_2_7_8}`,//申请总次数
      align: 'center',
      minWidth: 100,
      key: 'total_apply'
    },
    {
      title: `${i18n_lang.joinList85_v1_2_7_8}`,//申请成功次数
      align: 'center',
      minWidth: 100,
      key: 'success_apply'
    },
    ...
    {
      title: `${i18n_lang.joinList86_v1_2_7_8}`,//昨日充值金额
      align: 'center',
      minWidth: 100,
      key: 'yesterday_recharge_amount',
      render(h, { row }) {
        return <span>{`${row.yesterday_recharge_amount / 100}`}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{`${row.today_recharge_amount / 100}`}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{`${row.today_bet_amount / 100}`}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{`${row.total_recharge_amount / 100}`}</span>
      }
    },
    {
      ...
      render(h, { row }) {
        return <span>{`${row.total_bet_amount / 100}`}</span>
      }
    },
    {
    ...
    {
      title: `${i18n_lang.joinList87_v1_2_7_8}`,//赠送金额
      align: 'center',
      minWidth: 100,
      key: 'money',
      render(h, { row }) {
