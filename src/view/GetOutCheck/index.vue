  ...
  <div id="getOutCheck">
    ...
    <Card dis-hover class="query_box">
      <div class="query_con">
        ...
        <div class="item">
          <span>{{i18n_lang.getOutCheck152_v1_2_7_6}}</span>
          <Input v-model="query.fee" style="width: 180px" />
        </div>
        <div class="item">
          <span>{{i18n_lang.getOutCheck152_v1_2_7_8}}</span>
  ...
  methods: {
    ...
    async getThirdBalance() {
      ...
      if (res.status !== 200) {
        ...
        this.payInfo.balance = res.data ? MathDiv(res.data.balance, 100) : this.i18n_lang.getOutCheck61
      }
    },
    // 提交转账
    async savePay() {
