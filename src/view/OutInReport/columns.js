...
export const moneyColumns = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      render(h, { row }) {
        return <span>{MathDiv(row.deal_money, 100)}</span>
      },
      align: 'center',
      minWidth: 100
    },
    {
      ...
      render(h, { row }) {
        return <span>{MathDiv(row.balance, 100)}</span>
      },
      align: 'center',
      minWidth: 100
    },
...
export const moneyColumns2 = function(Vue) {
  const i18n = Vue.$t('outInReport')
  const formatDealType = type =>
    ({
      1: i18n.outInReport30,
  ...
  return [
    ...
    {
      title: i18n.outInReport83_v1_2_8_0,
      render(h, { row }) {
        return <span>{row.is_deduct > 0 ? i18n.outInReport85_v1_2_8_0 : i18n.outInReport86_v1_2_8_0}</span>
      },
      align: 'center',
      minWidth: 100
    },
    {
      title: i18n.outInReport87_v1_2_8_0,
      render(h, { row }) {
        return <span>{MathDiv(row.deduct_rebet, 100)}</span>
      },
      align: 'center',
      minWidth: 100
    },
    {
      title: i18n.outInReport88_v1_2_8_0,
      render(h, { row }) {
        return <span>{MathDiv(row.rebet, 100)}</span>
      },
      align: 'center',
      minWidth: 100
    },
...
export const backwaterColumns = function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      render(h, { row }) {
        return (
          <a href='javascript:;' on-click={_ => Vue.handleDetail1(row.classify, row.classify, 1, row.is_deduct)}>
