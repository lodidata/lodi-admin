export default Vue => {
  ...
  return [
    ...
    {
      title: i18n.userReport62_v_1_2_5_6,//手机号
      align: 'center',
      key: 'mobile',
      minWidth: 100,
      myExt: {
    ...
    {
      title: i18n.userReport63_v_1_2_5_6,//VIP等级
      align: 'center',
      minWidth: 80,
      key: 'ranting',
      myExt: {
    ...
    {
      title: i18n.userReport64_v_1_2_5_6,//上级代理ID
      align: 'center',
      minWidth: 80,
      key: 'agent_id',
      myExt: {
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: i18n.userReport65_v_1_2_5_6,
          align: 'center',
          minWidth: 100,
          key: 'recharge_range_count',
          sortable: 'custom',
          render(h, { row }) {
            return <span>{row.recharge_range_count}</span>
          }
        },
        {
        ...
        {
          title: i18n.userReport66_v_1_2_5_6,
          align: 'center',
          minWidth: 100,
          key: 'draw_range_count',
          sortable: 'custom',
          render(h, { row }) {
            return <span>{row.draw_range_count}</span>
          }
        },
        {
        ...
        {
          title: i18n.userReport67_v_1_2_5_6,
          align: 'center',
          key: 'recharge_count',
          minWidth: 100,
          sortable: 'custom',
          render(h, { row }) {
            return <span>{row.recharge_count}</span>
          }
        },
        {
        ...
        {
          title: i18n.userReport68_v_1_2_5_6,
          align: 'center',
          key: 'draw_count',
          minWidth: 100,
          sortable: 'custom',
    ...
    {
      title: i18n.userReport69_v_1_2_5_6,//最后登录IP
      align: 'center',
      key: 'login_ip',
      minWidth: 100,
      sortable: 'custom',
    ...
    {
      title: i18n.userReport70_v_1_2_5_6,//最后登录时间
      align: 'center',
      key: 'last_login',
      minWidth: 100,
      sortable: 'custom',
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: i18n.userReport71_v_1_2_5_6,
          align: 'center',
          key: 'deal_money_num',
          minWidth: 100,
          // sortable: 'custom',
          render(h, { row }) {
            return <span>{row.deal_money_num}</span>
          }
        }
      ]
    },
    {
      title: i18n.userReport38,//游戏盈亏
      align: 'center',
      key: "yk_data",
      myExt: {
        label: 'yk_data'
