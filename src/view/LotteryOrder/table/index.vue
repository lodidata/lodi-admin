  ...
  methods: {
    ...
    init() {
      ...
      if(JSON.parse(parameter).LotteryOrder){
        this.query = {
          user_name: JSON.parse(parameter).LotteryOrder.user_name ? JSON.parse(parameter).LotteryOrder.user_name : '', // 会员账号
          order_number: JSON.parse(parameter).LotteryOrder.order_number ? JSON.parse(parameter).LotteryOrder.order_number : '', // 注单号
          category: JSON.parse(parameter).LotteryOrder.category ? JSON.parse(parameter).LotteryOrder.category : '', // 筛选列表
          key: JSON.parse(parameter).LotteryOrder.key ? JSON.parse(parameter).LotteryOrder.key : '', // 筛选子id
          timeArr: JSON.parse(parameter).LotteryOrder.timeArr ? JSON.parse(parameter).LotteryOrder.timeArr : [formatDateToString(todayStart), formatDateToString(todayEnd)],
          ...
          orderby: JSON.parse(parameter).LotteryOrder.orderby ? JSON.parse(parameter).LotteryOrder.orderby : '',
          orderbyasc: JSON.parse(parameter).LotteryOrder.orderbyasc ? JSON.parse(parameter).LotteryOrder.orderbyasc : ''
        }
