    ...
    <div class="close-con">
      <Dropdown transfer style="margin-top:7px;" @on-click="handleTagsOption">
        ...
        <DropdownMenu slot="list">
          <DropdownItem name="close-all">{{i18n_lang.components26}}</DropdownItem>
          <DropdownItem name="close-others">{{i18n_lang.components27}}</DropdownItem>
        </DropdownMenu>
      </Dropdown>
    </div>
    <ul
...
export default {
  ...
  data() {
    ...
    return {
      ...
      visible: false,
      menuList: {
        others: i18n_lang.components26,
        all: i18n_lang.components27
      }
    }
  },
  computed: {
