<template>
  <div id="Info">
    ...
    <div class="info-box">
      ...
      <div>
        <span class="title">{{i18n_lang.components311_v1_5_7}}</span>
        <span>{{ info.id }}</span>
      </div>
      <div>
      ...
      <div>
        ...
        <span>{{ formatMoney(info.balance, 100) }}</span>
        <span style="margin-left: 5px;" @click="handleBalance">
          <Icon type="md-add-circle"/>
        </span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components312_v1_5_7}}</span>
        <span>{{ info.code }}</span>
      </div>
      <div>
      ...
      <div>
        <span class="title">{{i18n_lang.components313_v1_5_7}}</span>
        <span @click="curTabCut()" style="color: #2d8cf0; cursor: pointer;">{{ info.charge_cnt }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components314_v1_5_7}}</span>
        <span @click="curTabCut()" style="color: #2d8cf0; cursor: pointer;">{{ info.inferisors_num }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components315_v1_5_7}}</span>
        <span>{{ info.inferisors_all }}</span>
      </div>
      <div>
      ...
      <div>
        ...
        <span>{{i18n_lang.components85}} {{ info.user_data.deposit_num }} {{i18n_lang.components86}}{{ formatMoney(info.user_data.deposit_amount, 100) }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components87}}</span>
        <span>{{i18n_lang.components85}} {{ info.user_data.withdraw_num }} {{i18n_lang.components86}}{{ formatMoney(info.user_data.withdraw_amount, 100) }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components88}}</span>
        <span>{{i18n_lang.components85}} {{ info.user_data.active_num }} {{i18n_lang.components86}}{{ formatMoney(info.user_data.active_amount, 100) }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components277}}</span>
        <span>{{i18n_lang.components85}} {{ info.withdrawal_user_cnt }} {{i18n_lang.components86}}{{ formatMoney(info.withdrawal_user_amount, 100) }}</span>
      </div>
      <div>
        <span class="title">{{i18n_lang.components278}}</span>
        <span>{{i18n_lang.components85}} {{ info.deposit_user_cnt }} {{i18n_lang.components86}}{{ formatMoney(info.deposit_user_amount, 100) }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async changeConcat() {
      ...
      const req = this.edit.concat
      req.birth = req.birth ? this.$dateFormat(req.birth) : ''
      const res = await this.$axios.request({
