      ...
      <div style="padding-top: 16px;">
        <Tabs v-if="visible" v-model="curTab">
          <TabPane :label="i18n_lang.components55" name="info">
            <Info v-if="curTab === 'info'" :id="curUser.id" @curTabCut="curTabCut"></Info>
          </TabPane>
          ...
          <TabPane :label="i18n_lang.components311_v1_2_7_4" name="Rebate">
            <Rebate v-if="curTab === 'Rebate'" :id="curUser.id"></Rebate>
          </TabPane>
        </Tabs>
      </div>
    </Modal>
