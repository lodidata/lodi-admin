export default function(Vue) {
  ...
  return [
    ...
    },
    {
      ...
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.deal_money / 100}</span>
      }
    },
    {
      ...
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.withdraw_bet / 100}</span>
      }
    },
    {
      ...
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.balance / 100}</span>
      }
    },
    {
      ...
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.total_bet / 100}</span>
      }
    },
    {
      ...
      minWidth: 80,
      render(h, { row }) {
        return <span>{row.total_require_bet / 100}</span>
      }
    },
    {
      ...
      minWidth: 70,
      render(h, { row }) {
        return <span>{row.free_money / 100}</span>
      }
    },
    {
