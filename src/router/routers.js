...
export default [
  ...
  // 注单查询
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'miniGames',
        meta: {
          title: i18n_lang.router109_v_1_5_7,
          id: 4
        },
        component: () => import('@/view/MiniGames')
      }
    ]
  },
  //彩票管理
  ...
  // 现金管理
  {
    ...
    children: [
      ...
      {
        path: 'monetaryExchangeRate',
        name: 'monetaryExchangeRate',
        meta: {
          title: i18n_lang.router103_4_2,
          id: 388
        },
        component: () => import('@/view/MonetaryExchangeRate')
      },
      {
        path: 'thirdPayment',
        name: 'thirdPayment',
      ...
      },
      {
        ...
        name: 'backwater',
        meta: {
          title: i18n_lang.router108_backwater,
          id: 488
        },
        component: () => import('@/view/Backwater')
      },
      {
        path: 'directPushSetting',
        name: 'directPushSetting',
        meta: {
          title: i18n_lang.router107_v1_2_5_4,
          id: 446
        },
        component: () => import('@/view/DirectPushSetting')
      }
    ]
  },
  // 网站管理
  ...
  // 渠道管理
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: `${i18n_lang.router108_v1_2_6_3}`,//`【渠道包下载】下载页配置`
          id: 348
        },
